 ...
 * 
 * @ Author(s): Starter Code and Brittany Pruneau 
 */
public class ListVsSetDemo implements Serializable
{
	private static final long serialVersionUID = 5732796446779294955L;
	...
	/**
	 * Creates a string that includes all the elements in the set. Each element is
	 * followed by a new-line.
	 * 
